...
for i in range(1, 11):
    # for j in range(1, 2):
        ...
        sys.stdout = open(
            f'./result/busca_ligada/case_b/resultado_buscaListaLigada_aleatorio_{i}.txt', 'w')
        ...
        with open(f'./result/busca_ligada/case_b/resultado_buscaListaLigada_aleatorio_{i}.txt', 'w') as file:
