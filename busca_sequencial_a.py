...
for i in range(1, 11):
    for j in range(1, 4):
        ...
        sys.stdout = open(
            f'./result/busca_seq/case_a/resultado_buscaSequencial_aleatorio_{i}_{j}.txt', 'w')
        ...
        with open(f'./result/busca_seq/case_a/resultado_buscaSequencial_aleatorio_{i}_{j}.txt', 'w') as file:
